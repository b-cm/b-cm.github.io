...
VLA/19A-254: Disks and Outlows around O-type stars in W51
[2018]{style="float:right;clear:right"}

- Co-I, 15 hours, re-Approved


## Research Areas

Modeling Lyα-driven outﬂows in a Simulated Exoplanet Atmosphere
[2020 - Present]{style="float:right;clear:right"}

Radiation Hydrodynamics of Radius-Expanding Type-I X-ray Bursts
[2019 - Present]{style="float:right;clear:right"}

Developing Dust Radiative Transfer Algorithms for the “Powderday” Code Library
[2019]{style="float:right;clear:right"}

Time-Series Analysis of Ultramagnetic Variable Stars
[2018 - 2019]{style="float:right;clear:right"}

The YSO population of W51 at high resolution
[2018]{style="float:right;clear:right"}

Spectral Features of Quasar Dust Absorbers
[2016 - 2018]{style="float:right;clear:right"}


## Training

Flatiron Institute CCA Fluid Dynamics Summer School
[2023]{style="float:right;clear:right"}

\
NASA Advanced Supercomputing Division, Ames Research Center
[2022]{style="float:right;clear:right"}

*Science Collaborator*

\
McCormick Observatory
[2021]{style="float:right;clear:right"}
...
UVA Astronomy Diversity, Equity, and Inclusion (DEI) Committee
[2020 - 2023]{style="float:right;clear:right"}

*Co-Founder, Graduate Student Representative*

\
Central Virginia Governor’s School Mentorship Program
[2020 - 2023]{style="float:right;clear:right"}

*Lead Project Mentor for Astronomy*
...
\
Public Night At Historic McCormick Observatory
[2019 - 2024]{style="float:right;clear:right"}

*Lead Observer*

\
Univ. of Florida Astronomy and Astrophysics Society
[2017 - 2019]{style="float:right;clear:right"}

*Treasurer, Ambassador*

\
Univ. of Florida Women in Science Fair
[2018]{style="float:right;clear:right"}

*Co-Organizer for Astronomy, Volunteer*

## Software

Athena++: [https://github.com/PrincetonUniversity/athena](https://github.com/PrincetonUniversity/athena)
[Developer]{style="float:right;clear:right"}

Contributions: Monte Carlo Resonance Scattering and Modiﬁed Random Walk

\
Dendrocat: [https://dendrocat.readthedocs.io](https://dendrocat.readthedocs.io)
[Lead Developer]{style="float:right;clear:right"}

Detects and catalogs sources in radio images, enabling photometry

\
Powderday: [https://powderday.readthedocs.io](https://powderday.readthedocs.io)
[Developer]{style="float:right;clear:right"}
...
Head Teaching Assistant for UVA Astronomy
[2020 - 2021]{style="float:right;clear:right"}

ASTR 2110: Introduction to Astrophysics I (TA, Lecturer)
[2019 - 2020]{style="float:right;clear:right"}

AST 4723: Observational Techniques for Astronomy (TA)
[2018]{style="float:right;clear:right"}
...
Emilee Stonelake
[2022 - 2023]{style="float:right;clear:right"}

*Hydrodynamic Simulations of Rayleigh-Taylor Instability*

\
Aaron Dendy
[2022 - 2023]{style="float:right;clear:right"}

*A Numerical Model of Magentized Bondi Accretion*

\
Asia Hubbard
[2021 - 2022]{style="float:right;clear:right"}
...
*Simulated Spectra of Accreting Black Holes*
...
QVA Wavelength Scholarship
[2024]{style="float:right;clear:right"}
...
\
Inaugural Lead Major in Astrophysics
[2019]{style="float:right;clear:right"}

*University of Florida Class of 2019 Commencement Ceremony*

\
University of Florida Most Outstanding Senior Thesis Award
[2019]{style="float:right;clear:right"}
...
[2017]{style="float:right;clear:right"}

\
East Coast Charitable Foundation Scholarship
[2015 - 2019]{style="float:right;clear:right"}
